...
//vpx_imports
use App\Http\Middleware\Admin\HasSetAdminPassword;
use App\Http\Middleware\Admin\HasAdminAuth;
...
$middlewareAliases = [
    ...
    'HasSetAdminPassword' => HasSetAdminPassword::class,
    'HasAdminAuth' => HasAdminAuth::class,
];
