@extends('admin.layouts.main-layout',["tabTitle" => config('i.service_name')." | Update Profile " ])
@section('page')
@section('breadCum')
    <h4 class="mb-0">Setup Profile </h4>
...
<div class="thepage">
	<div id="defaultPage" class="pages">
		<div class="data-summary">
			<div class="card p-2">
				<form id="frmUpdateAdminSetupProfile" autocomplete="off">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group text-left mb-3">
                                                <div class="d-flex flex-row justify-content-between">
                                                    <label class="form-label" > <b> User Image  </b> <em class="required">*</em> <span id="image_error"></span></label>
                                                </div>
                                                <div class="input-group">
                                                ...
                                                @if(imageExists(Auth::user(),'300X300'))
                                                    ...
                                                    <p class=""> Uploaded Image <a href="{{ getRowImage(Auth::user(),'300X300') }}" download> Image </a></p>
                                                @else
