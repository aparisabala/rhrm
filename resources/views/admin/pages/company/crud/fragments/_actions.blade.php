<div class="tool-box d-flex flex-row justify-content-end align-items-center bread-cum">
    ...
    @if(count($data['items']) > 0)
        <button class="btn btn-success btn-rounded waves-effect waves-light d-flex justify-items-center align-items-center  fw-bold  me-2"><span class="bx bx-save"></span> <span class="d-none d-md-block ms-1"> Update  </span> </button>
        <button class="btn btn-danger btn-rounded waves-effect waves-light d-flex justify-items-center align-items-center  fw-bold  me-2"><span class="bx bx-trash"></span> <span class="d-none d-md-block ms-1">  Delete   </span> </button>
